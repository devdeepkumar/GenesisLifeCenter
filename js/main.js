...
// Email Validator 
 ...
 document
   ...
   .addEventListener("submit", function (e) {
     ...
     const validatorResult = document.getElementById("validator-newsletter");
     ...
     if (email === "") {
       validatorResult.textContent = "Please enter your email address.";
       validatorResult.style.color = "red";
     } else if (!emailRegex.test(email)) {
       validatorResult.textContent = "Please enter a valid email address.";
       validatorResult.style.color = "red";
     } else {
